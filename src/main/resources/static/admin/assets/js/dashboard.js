$(function () {
    ...
    var chart = {
        series: [{
            name: "Lợi nhuận tháng này", data: [355, 390, 300, 350, 390, 180, 355, 180, 355, 180, 355, 355]
        }],
        ...
        yaxis: {
            show: true, min: 0, max: 10000, tickAmount: 4, labels: {
                style: {
                    cssClass: "grey--text lighten-2--text fill-color",
                },
            },
        }, stroke: {
            show: true, width: 3, lineCap: "butt", colors: ["transparent"],
        },
