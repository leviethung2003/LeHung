...
var parameters = [{
    url: "https://online-gateway.ghn.vn/shiip/public-api/master-data/province", method: "GET", headers: {
        'Token': 'af00fa30-4f0e-11ee-96dc-de6f804954c9', 'Content-Type': 'application/json'
    },
}];
    ...
    .then(function (results) {
        ...
        citiesDropdown.addEventListener('change', function () {
            ...
            var districtsParameter = {
                url: "https://online-gateway.ghn.vn/shiip/public-api/master-data/district", method: "GET", headers: {
                    'Token': 'af00fa30-4f0e-11ee-96dc-de6f804954c9', 'Content-Type': 'application/json'
                }, params: {
        ...
        districtsDropdown.addEventListener('change', function () {
            ...
            var wardsParameter = {
                url: "https://online-gateway.ghn.vn/shiip/public-api/master-data/ward", method: "GET", headers: {
                    'Token': 'af00fa30-4f0e-11ee-96dc-de6f804954c9', 'Content-Type': 'application/json'
                }, params: {
                    "district_id": selectedDistrictID
                },
            };
            var apiUrl = wardsParameter.url;
            console.log(apiUrl);
